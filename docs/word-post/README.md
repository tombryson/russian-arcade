...
**Approved campaign direction, 9 September:** Barsik carries one letter to the learner through worlds unlocked with earned Lingocoins. At the ending, the learner deciphers that letter in an exam-style comprehension challenge using Russian practised along the route. The [canonical campaign brief](barsik-journey.md) records the narrative, curriculum contract, assessment requirements and implementation sequence. The welcome, first chapter and initial saved journey stops exist; the later worlds and final assessment remain unfinished. The passport remains removed.
...
| World unlocks | **Approved direction, 9 September 2026** | Total eligible Lingocoins earned unlock destinations; spending does not relock them | Earning policy and thresholds need pilot calibration; implementation must use real saved rewards |
