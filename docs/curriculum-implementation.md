...
| CU-05: first teaching sequence | Teaching, choices, typed forms, Writing and mapped Speaking implemented | Audio-dependent listening and learner validation across the sequence. |
...
The next release should finish the first sequence across response modes before multiplying units. A full A1–B2 reference catalogue is already present; a complete, validated A1–B2 course is not.
