...
def strip_course_progression(conn):
    ...
    for table in ('activity_criterion_reports', 'activity_task_contracts', 'course_checkpoint_followups', 'course_release_switches', 'course_target_observations', 'course_target_practice_receipts',
    ...
    conn.execute('DELETE FROM schema_migrations WHERE version IN (44,45,46,47,48,49)')
